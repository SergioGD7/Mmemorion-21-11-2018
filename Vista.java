...
public class Vista extends JFrame{
    ...
    public void crearPanel(){
        ...
        labelInicio=new Label("Choose the option you want in the top menu.");
        ...
        panelCartas.setBounds(0,0,1920,1080);
    ...
    public void crearCartas(int filas,int columnas){
        remove(panelCartas);
        panelCartas=new Panel();
        panelCartas.setBounds(10,10,1600,1010);
    ...
    public synchronized void crearContador(){
        ...
        nombreContador.setBounds(1700,5,150,50);
        nombreContador.setFont(new Font("Serif", Font.BOLD, 48));
        
        c=new Contador(this);
        
        contador=new Label();
        contador.setBounds(1700,80,150,50);
        contador.setFont(new Font("Serif", Font.BOLD, 48));
        
        nombrejugadas=new Label("Plays");
        nombrejugadas.setBounds(1680,200,150,50);
        nombrejugadas.setFont(new Font("Serif", Font.BOLD, 42));
        jugadas=new Label("0");
        jugadas.setBounds(1725,300,150,50);
   ...
   public void restablecerJugadas(){
    ...
    public void cerrarAplicacion(){
        int res = JOptionPane.showConfirmDialog(null, "Are you sure you want to leave?\nYou will lose all the data that you have not saved","Alert",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE);
